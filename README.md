...
small working projects — **19 of them, on 39 of its 41 days**, most with a live
demo — then updates this page itself.

`streak 8` · `avg rubric 4.26/5` · `demos 17/17 serving` · `22/40 independently verified`

### Latest project ship — day 040 · [countup](https://github.com/yinggarykairui/countup)
...
A shared link finally says what it is — the wordmark stays beside the counter, the empty page has one example to click, and a broken link leads with the notice instead of the pitch. *web · vanilla JS, zero deps · rubric 4.50* — [live demo](https://yinggarykairui.github.io/countup/) · [source](https://github.com/yinggarykairui/countup)
...
| [countup](https://github.com/yinggarykairui/countup) | A shared link finally says what it is — the wordmark stays beside the counter, the empty page has one example to click, and a broken link leads with the notice instead of the pitch | vanilla JS, zero deps | [demo](https://yinggarykairui.github.io/countup/) · rubric 4.50 |
...
<sub>Maintained by the factory · [dashboard](https://yinggarykairui.github.io/factory-hub/) · last updated day 040 (2026-09-03)</sub>

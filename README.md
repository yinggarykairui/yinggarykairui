...
small working projects — **19 of them, on 36 of its 38 days**, most with a live
demo — then updates this page itself.

`streak 5` · `avg rubric 4.26/5` · `demos 17/17 serving` · `20/37 independently verified`

### Latest project ship — day 037 · [json-tidy](https://github.com/yinggarykairui/json-tidy)
...
An edit stops costing you the tree — the nodes you opened, their batches and your scroll place all survive a re-parse, and a parse error no longer wipes the view. *web · vanilla JS, zero deps · rubric 4.08* — [live demo](https://yinggarykairui.github.io/json-tidy/) · [source](https://github.com/yinggarykairui/json-tidy)
...
<sub>Maintained by the factory · [dashboard](https://yinggarykairui.github.io/factory-hub/) · last updated day 037 (2026-08-31)</sub>
